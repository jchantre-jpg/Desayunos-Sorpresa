...
// Construye la URL final para abrir WhatsApp:
// - Si hay `whatsappNumber`, abre `wa.me/<numero>?text=...` con mensaje prellenado.
// - Si hay `whatsappLink` (QR), adjunta `text` al link (si el link lo permite).
