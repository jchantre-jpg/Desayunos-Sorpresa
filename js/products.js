...
const CONFIG = {
  // Enlace por si no tienes número (abre chat pero puede no llevar el mensaje pre-llenado)
  whatsappLink: 'https://wa.me/qr/AAEWDCVCR6AVI1',
  // Número del admin CON código de país, SIN + (ej: 573001234567). Si lo pones, al "Pedir por WhatsApp" se abrirá el chat con el mensaje del pedido ya escrito.
  whatsappNumber: '',
